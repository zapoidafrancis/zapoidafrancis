  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10 pt-32 pb-20">
        ...
        >
          Audio professional based in Berlin, blending creativity with technical expertise to craft immersive soundscapes and outstanding{' '}
      ...
      <div className="w-full overflow-hidden border-t border-b border-[#2a2a2a] py-4 md:py-6 mt-auto relative z-10">
        <div className="animate-marquee-seamless flex whitespace-nowrap items-center" style={{ width: 'fit-content' }}>
          {/* First set */}
          {roles.map((role, idx) => (
            <span 
              key={`a-${idx}`} 
