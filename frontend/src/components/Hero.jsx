  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10 pt-32 pb-20">
        ...
        >
          Audio professional based in Berlin, blending creativity with technical expertise to craft immersive soundscapes and <span className="whitespace-nowrap">outstanding sonic experiences.</span>
        </p>
