        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-5">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              />
              {isMobileMenuOpen && (
                <span className="md:hidden text-[#f0f0e8] text-xs tracking-[0.25em] uppercase mt-1 group-hover:text-[#a855f7] group-active:text-[#a855f7] transition-colors">Home</span>
              )}
            </a>
