      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="md:col-start-1 md:row-start-2 md:self-end flex flex-col items-start mt-16" data-testid="streaming-links">
