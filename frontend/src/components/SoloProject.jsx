  ...
  return (
    <section id="solo-project" className="min-h-screen bg-[#141414] text-[#f0f0e8] py-32 px-6 md:px-12 noise-bg relative">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Artist Bio Section - NOW BEFORE TABS */}
        <div className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-12 md:gap-y-0">
            ...
            <div className="md:col-start-1 md:row-start-2 md:self-end flex flex-col items-start mt-16 md:mt-0" data-testid="streaming-links">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a href="https://tidal.com/artist/29676090" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[#a0a0a0] hover:text-[#f0f0e8] transition-colors duration-300" data-testid="link-tidal">
        ...
        <div className="mb-24">
          ...
          {/* Music Tab */}
          {activeTab === 'music' && (
            <div className="space-y-6" data-testid="music-content">
